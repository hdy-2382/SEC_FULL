...
def _load_mgmt_rows_openpyxl() -> tuple[list[list], list[list], list[list]]:
    ...
    return code_rows, action_rows, adjud_rows
...
def _build_mass(pid: str, config: dict):
    ...
    config = _load_config()
    codes, actions, adjud = _load_mgmt()
