...
def gen_drum_poc():
    ...
    _write_config(pid, {
        ...
        # 개발 히스토리 (평가 상세 탭) — 실무 엔지니어 관점: 형상 변경·의사결정·산출물
        "pocHistory": {
            "changes": [   # 설계·형상 변경 이력 (ECN) — 유발 이슈 link
                {"date": "2026-06-19", "cat": "설계", "item": "설계 동결 v1", "change": "체결·반송 유닛 도면 확정", "reason": "제작 착수 기준", "link": ""},
                {"date": "2026-06-27", "cat": "셋업", "item": "비전 캘리브레이션", "change": "좌표계·조명 기준 설정", "reason": "랩 셀 셋업", "link": ""},
                {"date": "2026-07-01", "cat": "SW", "item": "조명 후드", "change": "후드 1차 개선 → 연장", "reason": "역광 오인식", "link": "ISS-004"},
                {"date": "2026-07-08", "cat": "부품", "item": "편광 필터", "change": "고반사 대응 필터 검토", "reason": "고반사 드럼 오인식", "link": "ISS-016"},
                {"date": "2026-07-09", "cat": "기구", "item": "토크 암", "change": "강성 보강 Rev A", "reason": "반력 편차 상한 근접", "link": "ISS-013"},
                {"date": "2026-07-11", "cat": "SW", "item": "통신 재접속 로직", "change": "재접속 시퀀스 변경", "reason": "비정상 FAIL(통신 두절)", "link": ""},
            ],
            "decisions": [   # 의사결정·협의 이력 (결정 로그)
                {"date": "2026-06-05", "topic": "컨셉 선정", "decision": "6축 로봇 안 채택", "by": "기술검토회", "note": "겐트리 대비 유연성 — 2안 비교"},
                {"date": "2026-06-12", "topic": "안전인증 컨셉", "decision": "펜스+인터록 설계 반영", "by": "안전조직 합의", "note": "위험원 12건 식별"},
                {"date": "2026-06-19", "topic": "판정기준 확정", "decision": "72h 무에러·비정상 8종·기성능 3항목", "by": "수혜부서 서면 합의", "note": "사후 변경 금지 (잣대 동결)"},
                {"date": "2026-07-13", "topic": "Pilot 지표 정의", "decision": "MCBF·MTTR 산식 협의 착수", "by": "3자 협의체", "note": "수혜부서 참여 — TECOP P 리스크"},
            ],
            "docs": [   # 산출물·문서
                {"name": "판정기준서 v1", "type": "기준", "date": "2026-06-19", "owner": "PM"},
                {"name": "FMEA 초판 (DRM-01~08)", "type": "FMEA", "date": "2026-06-19", "owner": "박OO"},
                {"name": "위험성 평가 v0", "type": "안전", "date": "2026-06-12", "owner": "안전"},
                {"name": "설계 도면 세트 v1", "type": "설계", "date": "2026-06-19", "owner": "김OO"},
                {"name": "POC 결과 보고서", "type": "보고", "date": "작성 중", "owner": "PM"},
            ],
        },
