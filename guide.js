...
function renderGuide() {
  ...
  <div class="grid g2">
    ...
    <div class="panel gd-hl">
      ...
      <p>${GD_OURS()} 사내 기술개발·적용 부서 기준 재정의 (docs/CRITERIA.md §7) —
      ① 게이트 리뷰 <b>고정 안건 체크</b>로 전용 ② <b>E=투자·효과</b>(투자심의 입력치·TCO 가정),
      <b>C=잣대·업체 계약</b>(합격 기준 서면 동결 상태), <b>O=부서 안 실행</b>(R&amp;R·업체 관리),
      <b>P=이해·안전</b>(부서 밖 합의: 수혜부서·경영 + 안전인증 — 복합축 worst-of 판정)
      ③ 값은 자동 계산이 아니라 <b>PM의 판단</b>(양호/주의 + 비고 필수 — '양호'도 근거 한 줄).</p>
